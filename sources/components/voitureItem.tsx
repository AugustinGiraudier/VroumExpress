...
export default function VoitureListItem(props: voitureItemProps) {
    ...
    return (
        <View style={[styles.semiLightContainer]}>
            <TouchableOpacity style={{width:"100%", margin:0}}
                ...
                <View style={[styles.lightContainer, {alignItems: "center"}]}>
                    <Image style={styles.carImage} source={{uri: props.item.image}}/>
                    <View>
                        <Text style={styles.title}>{props.item.marque} {props.item.modele}</Text>
                    </View>
                </View>
            </TouchableOpacity>
        </View>
